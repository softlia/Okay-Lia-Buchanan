...
# ── Banner ────────────────────────────────────────────────────────────────────
# Embedded ASCII art. Kept inline so the script stays self-contained
# (no external .txt dependency at runtime).
_ASCII_ART = r"""&&&&&&&&&&&&&&&&&&&&&&&&&&&&+xxxxx:+xxxxxxxxxxxxxxxxx+::$&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&&&xxxxx;+xxxxxxxxxxxxxxxx+:+x::::$&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&$xxxx+x+xxxxxxxxxxxxxxxxxxx+.::::.&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&xxxx;;+xxxxxxxxxxxxxxx+xxxxxxx:::.$&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&X+x;;;xxxxxx+:x+xxxxxxx+xx;xxxx:..:.&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&++xx:xxx++x.+:x:;xxxx++:.++xxxx+....:;+++;$&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&$+x::x;;:+xXx&x.:+x;+x:+.xx+x;xx.:.x.&&&&&;XXx&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&&x+:++:;:X;++++:Xx+:xx:x.;::x;x+;..;x$&&&&X:XXXx&&&&&&&&&&&&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&&&&&&&:....+:+++:$$:..&&;x;$+:;x.::+.+;xx:+..:&$:xxx+XXXXXXx;&&&&&&&&&&&&&&&&&&&&&&&&
...
&&&&&&&&&&&&&&&&xXXXX;XXXXXxXXX..:..:............:+$Xx.....;X$$$$x.......:XXXXXXXXX.&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&&XXXXXXXXXX;XXXx++x...::........:..&+.X&X....&&x.;x&&......:XXXXXXXX+:&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&&XXXXX+XXXXXX;XXXXXX;::..:::.......:&..+X$..::&$...;$&.......;;xXXXXX;;&&&&&&&&&&&&&&&&
&&&&&&&&&&&&&XXXXXxXXXXXXXXxXxX:+X;:...::::......&...;xXXXX+&....&&......:::;;::x:::&&&&&&&&&&&&&&&&
&&&&&&&&&&&&XXX+XXXXXXXXXXXXX:XX+::X....::::.....x&+xXXXXX$$$$Xx$&;.......::::::;;;:&&&&&&&&&&&&&&&&
&&&&&&&&&&&+XXXXxXXXXXXXXXXXXXX;;X.::...:;::.....+xxXXXXX$$$$$$$$$X.......:;;:;:;:.&&&&&&&&&&&&&&&&&
&&&&&&&&&&&XXXXXXxxXXXXXXXXXXXXXx;:;:...;:::....:xxXXXXX$$$$$$$xxxX................&&&&&&&&&&&&&&&&&
&&&&&&&&&&;XXx;;;+;XXXXXXXXXXXXXXXX::...::;:.....:;XXX$$$$$X+xxxXx;...+;. .........&&&&&&&&&&&&&&&&&
&&&&&&&&&&XXXXXX::;;XXXXXXXXXXXXXXXXxX+..:;......:X++xxxxxxxxx+X$$X:...+x+.........&&&&&&&&&&&&&&&&&
&&&&&&&&&$XXXXXXXX:;;XXXXXXXXXXXXXXXXXXXX::......:XXX+++++++x$X$$&&$...............&&&&&&&&&&&&&&&&&
&&&&&&&&&&XXXXXXX+xXXXXXXXXXXXXXXXXXXXXXXXXX:....&&$XXXXX$XX$$$&&&&&&..............:&&&&&&&&&&&&&&&&
&&&&&&&&&&;;;;:::::XXXXXXXXXXXXXXXXXXXXXXXXXXX:.&&&&$XXXXX$&&&&&&&&&&&..............&&&&&&&&&&&&&&&&
&&&&&&&&&&&:::::::::xXXXXXXXXXXXXXXXXXXXXXXXXXXXx&&&&&&&&&&&&&&&&&&&&&$.............&&&&&&&&&&&&&&&&
&&&&&&&&&&&x::::::::::;xXXX;;+XXXXXXXXXXXXXXXXXXXXX;&&&&&&&&&&&&&&&&&&&.............&&&&&&&&&&&&&&&&
&&&&&&&&&&XX+.;::::::::..:::;;:;+XXXXXXXXXXXXXXXXXXXXX$&&&&&&&&&&&&&&&&X............&&&&&&&&&&&&&&&&
&&&&&&&&&&XXXXXXx:...:.......::::::xXXXXXXXXXXXXXXXXXXXXX;$&&&&&$$$$X$$&+............$&&&&&&&&&&&&&&
&&&&&&&&&;XXXXXXXXXxX:.............::+XXXXXXXXXXXXXXXXXXXXXXX$;&&&&&&$$X$&...::.......&&&&&&&&&&&&&&
...
&&xX+:::xx;:&x++$++.::$xxxXxxXXXXXXXXXXX$:...X&&&&&$................&&&&XXXXx;........+XXXx&&&&&&&&&
&&&.:::::x;:;++xxx;:;x+xXXXXXXXXXXXXXXXXXX:....;&&&&&:...............&$$XXXXXx+;::;+xxXXXXX&&&&&&&&&
&&&:::xxx+;.::+.:XxX;::xXXXXXXXXXXXXXXXXXX$;.. ..;&&&&&...............$$XxXXXxxxxxxxXXXXXXXX&&&&&&&&
&&&&&&&X;.....:::..::.+xXXXXXXXXXXXXXXXXXXXX+... .x&&&&&+..............XXxXXXXXXXXXXXXXXXXXXXX&&&&&&
&&&&&&&&&&xX;xxxx..;x+xxxXXXXXXXXXXXXXXXXXXX$x....&&&&&&& ...............;XXXXXXXXXXXXXXXXXXXXXX$&&&
&&&&&&&&&&&&&XxxxxxxxxxxxXXXXXXXXXXXXXXXXXXXXXx$&&&&&&&&&x........ ........:XXXXXXXXXXXXXXXXXXXXX&&&
&&&&&&&&&&&&&&&&xxxxxxxxXXXXXXXXXXXXXXXXXXXXXXXxx&&&&&&&&&....................$XXXXXXXXXXXXXXXXxx&&&
&&&&&&&&&&&&&&&&&xxxxxxxXXXXXXXXXXXXXXXXXXXXXXXX+:+&&&&&&&:..... ...............$XXXXXXXXXXXxx:&&&&&
&&&&&&&&&&&&&&&&&&x+xxxxXXXXXXXXXXXXXXXXXXXXXXXX+;...............................xXXXXXXxx+:...;&&&&
&&&&&&&&&&&&&&&&&&&&Xxx++xxxxxxxXXXXXXXXXXXXXXXx+;:.................................Xxx+x:....&&&&&&
&&&&&&&&&&&&&&&&&&&&&&&&&&&&$;++++++xxxxXXXXXxx+;;.....+++++++:........................xxxxxX&&&&&&&"""

BANNER = (
    f"{Colors.CYAN}{Colors.BOLD}{_ASCII_ART}{Colors.RESET}\n"
    f"{Colors.CYAN}{Colors.BOLD}                       SENTINEL PORT SCANNER v1.0{Colors.RESET}\n"
    f"{Colors.DIM}                Fast, Lightweight Network Reconnaissance Tool{Colors.RESET}\n"
)
...
# ── Entry point ───────────────────────────────────────────────────────────────
def main() -> None:
    # Print banner BEFORE argparse so it shows even when args are missing/invalid.
    # Respect --no-banner without invoking argparse (cheap manual check).
